...
function Process_AllCheckboxes()
	...
	if(Natur_AccountOptions[52]) then ShowMyCooldownsCheck:SetChecked(true); end;
	...
	if(Natur_AccountOptions[102]) then ShowMyBuffsCheck:SetChecked(true); end;
	if(Natur_AccountOptions[112]) then ShowMyDebuffsCheck:SetChecked(true); end;
...
function Process_EnableAddon()
	...
	if(CheckboxEnabled == true) then Natur_PerCharOptions[1] = true 
...
function GroupUpTimersCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[2] = true 
...
function ShowFriendlyCastsCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[62] = true 
...
-- show my buffs
function ShowMyBuffsCheck_OnClick()
	local CheckboxEnabled = ShowMyBuffsCheck:GetChecked();
	if(CheckboxEnabled == true) then Natur_AccountOptions[102] = true 
	else Natur_AccountOptions[102] = false end;	
	-- update the groups
	Natur_SetAnchor(Natur_AccountOptions[1]);
	-- redo the timers.
	Natur_ReadTargetBuffs();
...
function ShowMyCooldownsCheck_OnClick()
	local CheckboxEnabled = ShowMyCooldownsCheck:GetChecked();
	if(CheckboxEnabled == true) then Natur_AccountOptions[52] = true 
	else Natur_AccountOptions[52] = false end;	
	-- update the groups
	Natur_SetAnchor(Natur_AccountOptions[1]);
	-- redo the timers.
	Natur_ReadTargetBuffs();
...
-- show my debuffs
function ShowMyDebuffsCheck_OnClick()
	local CheckboxEnabled = ShowMyDebuffsCheck:GetChecked();
	if(CheckboxEnabled == true) then Natur_AccountOptions[112] = true 
	else Natur_AccountOptions[112] = false end;	
	-- update the groups
	Natur_SetAnchor(Natur_AccountOptions[1]);
	-- redo the timers.
	Natur_ReadTargetBuffs();
...
function ShowHostileCastsCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[22] = true 
...
function ShowOnlyMyTargetsSpells_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[130] = true 
...
function ShowHostileCooldownsCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[137] = true 
...
function ShowDiminishReturnsCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[92] = true 
...
function AutoReputationBarChange_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[131] = true 
...
function MaxCombosFinishHimSound_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[134] = true 
...
function PlayFinishHimOnNPC_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[135] = true 
...
function PlayUnrealPvPSounds_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[127] = true 
...
function UseMaleUnrealSounds_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[128] = "Male" 
...
function PlayUnrealPvPOnNPC_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[129] = true 
...
function DKDeathGripSound_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[132] = true 
...
function ShowRogueWarning_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[124] = true 
...
function PlayRogueSound_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[125] = true 
	else Natur_AccountOptions[125] = false end;				
end

function RogueFlashGUI_OnClick()
	local CheckboxEnabled = RogueFlashGUI:GetChecked();
	if(CheckboxEnabled == true) then Natur_AccountOptions[126] = true 
...
function ShowCastsWithoutTF_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[113] = true 
...
function AnnounceSpellMisses_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[119] = true 
...
function SpellMissPlaySound_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[120] = true 
...
function SpellMissFlashGUI_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[121] = true 
...
function AnnounceAppliedCC_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[115] = true 
...
function AnnounceOnCCBreaks_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[116] = true 
...
function PlaySoundOnCCBreak_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[117] = true 
...
function FlashUIOnCCBreak_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[118] = true 
...
function ShowTargetDebuffsCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[42] = true 
...
function ShowTargetGainsCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[32] = true 
...
function ShowAllDRAroundMe_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[122] = true 
...
function SpellMonitoringCheck_OnClick()
	...
	if(CheckboxEnabled == true) then Natur_AccountOptions[123] = true 
